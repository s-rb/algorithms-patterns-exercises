 ...
 * Начиная от данного элемента двигаемся в начало массива, сравнивая маркерный элемент с текущим
 * Если текущий элемент больше или равен запомненному, то перезаписываем его (сдвигаем вправо)
