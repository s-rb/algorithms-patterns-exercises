...
import data_structures.double_linked_list.DoubleLinkedList;
import data_structures.single_linked_list.ListItem;
import data_structures.single_linked_list.SingleLinkedList;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        data_structures.double_linked_list.ListItem dItem = new data_structures.double_linked_list.ListItem("1"); // 1
        System.out.println("Создаем элемент " + dItem.getData() + " и вносим его в список");
        DoubleLinkedList dList = new DoubleLinkedList();
        dList.addToHead(dItem);
        data_structures.double_linked_list.ListItem dItem2 = new data_structures.double_linked_list.ListItem("2");
        data_structures.double_linked_list.ListItem dItem3 = new data_structures.double_linked_list.ListItem("3");
        data_structures.double_linked_list.ListItem dItem4 = new data_structures.double_linked_list.ListItem("4");
        data_structures.double_linked_list.ListItem dItem5 = new data_structures.double_linked_list.ListItem("5");
